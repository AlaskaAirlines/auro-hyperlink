...
title: 'auro-hyperlink: [vX.X-rc]'
labels: release
assignees: braven112
---

The following items are to be included with the next feature release of the `auro-hyperlink`, all PRs are to be from the feature branch to `vX.X-rc` branch.
