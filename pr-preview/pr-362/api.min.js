...
class ComponentBase extends AuroElement {
  ...
  /**
   * DEPRECATED - use `appearance="inverse"` instead. Alias of `ondark`, kept for backward compatibility; scheduled for removal in the next major version.
   * @deprecated
   * @type {boolean}
   */
  get onDark() {
